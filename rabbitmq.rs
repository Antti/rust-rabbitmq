...
extern "C" {
    ...
    pub fn amqp_hostcheck(match_pattern: *c_schar, hostname: *c_schar) ->
     c_int;
    pub fn memchr(arg1: *c_void, arg2: c_int, arg3: size_t) -> *mut c_void;
    pub fn memcmp(arg1: *c_void, arg2: *c_void, arg3: size_t) -> c_int;
    pub fn memcpy(arg1: *mut c_void, arg2: *c_void, arg3: size_t) ->
     *mut c_void;
    pub fn memmove(arg1: *mut c_void, arg2: *c_void, arg3: size_t) ->
     *mut c_void;
    pub fn memset(arg1: *mut c_void, arg2: c_int, arg3: size_t) ->
     *mut c_void;
    pub fn strcat(arg1: *mut c_schar, arg2: *c_schar) -> *mut c_schar;
    pub fn strchr(arg1: *c_schar, arg2: c_int) -> *mut c_schar;
    pub fn strcmp(arg1: *c_schar, arg2: *c_schar) -> c_int;
    pub fn strcoll(arg1: *c_schar, arg2: *c_schar) -> c_int;
    pub fn strcpy(arg1: *mut c_schar, arg2: *c_schar) -> *mut c_schar;
    pub fn strcspn(arg1: *c_schar, arg2: *c_schar) -> size_t;
    pub fn strerror(arg1: c_int) -> *mut c_schar;
    pub fn strlen(arg1: *c_schar) -> size_t;
    pub fn strncat(arg1: *mut c_schar, arg2: *c_schar, arg3: size_t) ->
     *mut c_schar;
    pub fn strncmp(arg1: *c_schar, arg2: *c_schar, arg3: size_t) -> c_int;
    pub fn strncpy(arg1: *mut c_schar, arg2: *c_schar, arg3: size_t) ->
     *mut c_schar;
    pub fn strpbrk(arg1: *c_schar, arg2: *c_schar) -> *mut c_schar;
    pub fn strrchr(arg1: *c_schar, arg2: c_int) -> *mut c_schar;
    pub fn strspn(arg1: *c_schar, arg2: *c_schar) -> size_t;
    pub fn strstr(arg1: *c_schar, arg2: *c_schar) -> *mut c_schar;
    pub fn strtok(arg1: *mut c_schar, arg2: *c_schar) -> *mut c_schar;
    pub fn strxfrm(arg1: *mut c_schar, arg2: *c_schar, arg3: size_t) ->
     size_t;
    pub fn strtok_r(arg1: *mut c_schar, arg2: *c_schar,
                    arg3: *mut *mut c_schar) -> *mut c_schar;
    pub fn strerror_r(arg1: c_int, arg2: *mut c_schar, arg3: size_t) -> c_int;
    pub fn strdup(arg1: *c_schar) -> *mut c_schar;
    pub fn memccpy(arg1: *mut c_void, arg2: *c_void, arg3: c_int,
                   arg4: size_t) -> *mut c_void;
    pub fn stpcpy(arg1: *mut c_schar, arg2: *c_schar) -> *mut c_schar;
    pub fn stpncpy(arg1: *mut c_schar, arg2: *c_schar, arg3: size_t) ->
     *mut c_schar;
    pub fn strndup(arg1: *c_schar, arg2: size_t) -> *mut c_schar;
    pub fn strnlen(arg1: *c_schar, arg2: size_t) -> size_t;
    pub fn strsignal(sig: c_int) -> *mut c_schar;
    pub fn memset_s(arg1: *mut c_void, arg2: rsize_t, arg3: c_int,
                    arg4: rsize_t) -> errno_t;
    pub fn memmem(arg1: *c_void, arg2: size_t, arg3: *c_void, arg4: size_t) ->
     *mut c_void;
    pub fn memset_pattern4(arg1: *mut c_void, arg2: *c_void, arg3: size_t);
    pub fn memset_pattern8(arg1: *mut c_void, arg2: *c_void, arg3: size_t);
    pub fn memset_pattern16(arg1: *mut c_void, arg2: *c_void, arg3: size_t);
    pub fn strcasestr(arg1: *c_schar, arg2: *c_schar) -> *mut c_schar;
    pub fn strnstr(arg1: *c_schar, arg2: *c_schar, arg3: size_t) ->
     *mut c_schar;
    pub fn strlcat(arg1: *mut c_schar, arg2: *c_schar, arg3: size_t) ->
     size_t;
    pub fn strlcpy(arg1: *mut c_schar, arg2: *c_schar, arg3: size_t) ->
     size_t;
    pub fn strmode(arg1: c_int, arg2: *mut c_schar);
    pub fn strsep(arg1: *mut *mut c_schar, arg2: *c_schar) -> *mut c_schar;
    pub fn swab(arg1: *c_void, arg2: *mut c_void, arg3: ssize_t);
    pub fn bcmp(arg1: *c_void, arg2: *c_void, arg3: size_t) -> c_int;
    pub fn bcopy(arg1: *c_void, arg2: *mut c_void, arg3: size_t);
    pub fn bzero(arg1: *mut c_void, arg2: size_t);
    pub fn index(arg1: *c_schar, arg2: c_int) -> *mut c_schar;
    pub fn rindex(arg1: *c_schar, arg2: c_int) -> *mut c_schar;
    pub fn ffs(arg1: c_int) -> c_int;
    pub fn strcasecmp(arg1: *c_schar, arg2: *c_schar) -> c_int;
    pub fn strncasecmp(arg1: *c_schar, arg2: *c_schar, arg3: size_t) -> c_int;
    ...
    pub fn accept(arg1: c_int, arg2: *mut Struct_sockaddr,
                  arg3: *mut socklen_t) -> c_int;
    pub fn bind(arg1: c_int, arg2: *Struct_sockaddr, arg3: socklen_t) ->
     c_int;
    pub fn connect(arg1: c_int, arg2: *Struct_sockaddr, arg3: socklen_t) ->
     c_int;
    pub fn getpeername(arg1: c_int, arg2: *mut Struct_sockaddr,
                       arg3: *mut socklen_t) -> c_int;
    pub fn getsockname(arg1: c_int, arg2: *mut Struct_sockaddr,
                       arg3: *mut socklen_t) -> c_int;
    pub fn getsockopt(arg1: c_int, arg2: c_int, arg3: c_int,
                      arg4: *mut c_void, arg5: *mut socklen_t) -> c_int;
    pub fn listen(arg1: c_int, arg2: c_int) -> c_int;
    pub fn recv(arg1: c_int, arg2: *mut c_void, arg3: size_t, arg4: c_int) ->
     ssize_t;
    pub fn recvfrom(arg1: c_int, arg2: *mut c_void, arg3: size_t, arg4: c_int,
                    arg5: *mut Struct_sockaddr, arg6: *mut socklen_t) ->
     ssize_t;
    pub fn recvmsg(arg1: c_int, arg2: *mut Struct_msghdr, arg3: c_int) ->
     ssize_t;
    pub fn send(arg1: c_int, arg2: *c_void, arg3: size_t, arg4: c_int) ->
     ssize_t;
    pub fn sendmsg(arg1: c_int, arg2: *Struct_msghdr, arg3: c_int) -> ssize_t;
    pub fn sendto(arg1: c_int, arg2: *c_void, arg3: size_t, arg4: c_int,
                  arg5: *Struct_sockaddr, arg6: socklen_t) -> ssize_t;
    pub fn setsockopt(arg1: c_int, arg2: c_int, arg3: c_int, arg4: *c_void,
                      arg5: socklen_t) -> c_int;
    ...
    pub fn socketpair(arg1: c_int, arg2: c_int, arg3: c_int, arg4: *mut c_int)
     -> c_int;
    pub fn sendfile(arg1: c_int, arg2: c_int, arg3: off_t, arg4: *mut off_t,
                    arg5: *mut Struct_sf_hdtr, arg6: c_int) -> c_int;
    pub fn pfctlinput(arg1: c_int, arg2: *mut Struct_sockaddr);
    pub fn setipv4sourcefilter(arg1: c_int, arg2: Struct_in_addr,
                               arg3: Struct_in_addr, arg4: uint32_t,
                               arg5: uint32_t, arg6: *mut Struct_in_addr) ->
     c_int;
    pub fn getipv4sourcefilter(arg1: c_int, arg2: Struct_in_addr,
                               arg3: Struct_in_addr, arg4: *mut uint32_t,
                               arg5: *mut uint32_t, arg6: *mut Struct_in_addr)
     -> c_int;
    pub fn setsourcefilter(arg1: c_int, arg2: uint32_t,
                           arg3: *mut Struct_sockaddr, arg4: socklen_t,
                           arg5: uint32_t, arg6: uint32_t,
                           arg7: *mut Struct_sockaddr_storage) -> c_int;
    pub fn getsourcefilter(arg1: c_int, arg2: uint32_t,
                           arg3: *mut Struct_sockaddr, arg4: socklen_t,
                           arg5: *mut uint32_t, arg6: *mut uint32_t,
                           arg7: *mut Struct_sockaddr_storage) -> c_int;
    pub fn inet6_option_space(arg1: c_int) -> c_int;
    pub fn inet6_option_init(arg1: *mut c_void,
                             arg2: *mut *mut Struct_cmsghdr, arg3: c_int) ->
     c_int;
    pub fn inet6_option_append(arg1: *mut Struct_cmsghdr, arg2: *__uint8_t,
                               arg3: c_int, arg4: c_int) -> c_int;
    pub fn inet6_option_alloc(arg1: *mut Struct_cmsghdr, arg2: c_int,
                              arg3: c_int, arg4: c_int) -> *mut __uint8_t;
    ...
    pub fn inet6_option_find(arg1: *Struct_cmsghdr, arg2: *mut *mut __uint8_t,
                             arg3: c_int) -> c_int;
    pub fn inet6_rthdr_space(arg1: c_int, arg2: c_int) -> size_t;
    pub fn inet6_rthdr_init(arg1: *mut c_void, arg2: c_int) ->
     *mut Struct_cmsghdr;
    pub fn inet6_rthdr_add(arg1: *mut Struct_cmsghdr, arg2: *Struct_in6_addr,
                           arg3: c_uint) -> c_int;
    pub fn inet6_rthdr_lasthop(arg1: *mut Struct_cmsghdr, arg2: c_uint) ->
     c_int;
    pub fn inet6_rthdr_segments(arg1: *Struct_cmsghdr) -> c_int;
    pub fn inet6_rthdr_getaddr(arg1: *mut Struct_cmsghdr, arg2: c_int) ->
     *mut Struct_in6_addr;
    pub fn inet6_rthdr_getflags(arg1: *Struct_cmsghdr, arg2: c_int) -> c_int;
    pub fn inet6_opt_init(arg1: *mut c_void, arg2: socklen_t) -> c_int;
    pub fn inet6_opt_append(arg1: *mut c_void, arg2: socklen_t, arg3: c_int,
                            arg4: __uint8_t, arg5: socklen_t, arg6: __uint8_t,
                            arg7: *mut *mut c_void) -> c_int;
    pub fn inet6_opt_finish(arg1: *mut c_void, arg2: socklen_t, arg3: c_int)
     -> c_int;
    pub fn inet6_opt_set_val(arg1: *mut c_void, arg2: c_int,
                             arg3: *mut c_void, arg4: socklen_t) -> c_int;
    pub fn inet6_opt_next(arg1: *mut c_void, arg2: socklen_t, arg3: c_int,
                          arg4: *mut __uint8_t, arg5: *mut socklen_t,
                          arg6: *mut *mut c_void) -> c_int;
    pub fn inet6_opt_find(arg1: *mut c_void, arg2: socklen_t, arg3: c_int,
                          arg4: __uint8_t, arg5: *mut socklen_t,
                          arg6: *mut *mut c_void) -> c_int;
    pub fn inet6_opt_get_val(arg1: *mut c_void, arg2: c_int,
                             arg3: *mut c_void, arg4: socklen_t) -> c_int;
    pub fn inet6_rth_space(arg1: c_int, arg2: c_int) -> socklen_t;
    pub fn inet6_rth_init(arg1: *mut c_void, arg2: socklen_t, arg3: c_int,
                          arg4: c_int) -> *mut c_void;
    pub fn inet6_rth_add(arg1: *mut c_void, arg2: *Struct_in6_addr) -> c_int;
    pub fn inet6_rth_reverse(arg1: *c_void, arg2: *mut c_void) -> c_int;
    pub fn inet6_rth_segments(arg1: *c_void) -> c_int;
    pub fn inet6_rth_getaddr(arg1: *c_void, arg2: c_int) ->
     *mut Struct_in6_addr;
    pub fn addrsel_policy_init();
    pub fn bindresvport(arg1: c_int, arg2: *mut Struct_sockaddr_in) -> c_int;
    pub fn bindresvport_sa(arg1: c_int, arg2: *mut Struct_sockaddr) -> c_int;
    pub fn inet_addr(arg1: *c_schar) -> in_addr_t;
    pub fn inet_ntoa(arg1: Struct_in_addr) -> *mut c_schar;
    pub fn inet_ntop(arg1: c_int, arg2: *c_void, arg3: *mut c_schar,
                     arg4: socklen_t) -> *c_schar;
    pub fn inet_pton(arg1: c_int, arg2: *c_schar, arg3: *mut c_void) -> c_int;
    pub fn ascii2addr(arg1: c_int, arg2: *c_schar, arg3: *mut c_void) ->
     c_int;
    pub fn addr2ascii(arg1: c_int, arg2: *c_void, arg3: c_int,
                      arg4: *mut c_schar) -> *mut c_schar;
    pub fn inet_aton(arg1: *c_schar, arg2: *mut Struct_in_addr) -> c_int;
    ...
    pub fn inet_network(arg1: *c_schar) -> in_addr_t;
    pub fn inet_net_ntop(arg1: c_int, arg2: *c_void, arg3: c_int,
                         arg4: *mut c_schar, arg5: __darwin_size_t) ->
     *mut c_schar;
    pub fn inet_net_pton(arg1: c_int, arg2: *c_schar, arg3: *mut c_void,
                         arg4: __darwin_size_t) -> c_int;
    pub fn inet_neta(arg1: in_addr_t, arg2: *mut c_schar,
                     arg3: __darwin_size_t) -> *mut c_schar;
    pub fn inet_nsap_addr(arg1: *c_schar, arg2: *mut c_uchar, arg3: c_int) ->
     c_uint;
    pub fn inet_nsap_ntoa(arg1: c_int, arg2: *c_uchar, arg3: *mut c_schar) ->
     *mut c_schar;
